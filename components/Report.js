...
const Report = () => {
    const [summaryLang, setSummaryLang] = React.useState('fr');
                ...
                options: {
                    ...
                    scales: {
                        y: {
                            ...
                            ticks: { color: '#8B949E', callback: (value) => value + 'B' }
                        },
                        x: {
                            grid: { display: false },
                            ticks: { color: '#8B949E' }
    ...
    const formatValue = (val, unit) => {
        if (unit === 'DZD') return formatDZD(val);
    ...
    const getStatusIcon = (prev, curr, higherIsWorse) => {
        ...
        if (diff === 0) return <div className="icon-minus text-fog" title="Stable"></div>;
        
        const isBetter = higherIsWorse ? diff < 0 : diff > 0;
        if (isBetter) {
            return <div className="icon-arrow-down text-green" title="Improved"></div>;
        } else {
            return <div className="icon-arrow-up text-red" title="Worsened"></div>;
        }
    };
            ...
            <div className="sticky top-[56px] z-30 bg-slate/90 backdrop-blur border-b border-ash py-4 px-8 mb-8 flex items-center justify-between">
                <div className="flex items-center gap-6">
                    ...
                    <div className="relative">
                        ...
                        <div className="icon-chevron-down absolute right-2.5 top-2 text-fog text-sm pointer-events-none"></div>
                    </div>
                </div>
                
                <div className="flex gap-3">
                    <button className="btn-outline bg-carbon shadow-sm">
                        <div className="icon-columns mr-2"></div> Compare Months
                    </button>
                    <button className="btn-primary shadow-md">
                        <div className="icon-file-down mr-2"></div> Export PDF
                    </button>
                </div>
            </div>
            ...
            <div className="report-container">
                ...
                <div className="report-section">
                    <div className="flex justify-between items-center mb-6 border-b border-ash pb-2">
                        <h2 className="font-mono text-[18px] font-semibold text-pure uppercase tracking-wider flex items-center gap-3">
                            <div className="icon-file-text text-teal"></div>
                            Executive Summary
                        </h2>
                    ...
                    <div className="bg-graphite/50 border-l-[4px] border-amber rounded-r-[8px] p-6 relative overflow-hidden">
                        ...
                        <p className={`font-sans text-[15px] leading-relaxed text-cloud ${summaryLang === 'ar' ? 'font-arabic text-right text-[16px]' : ''}`} dir={summaryLang === 'ar' ? 'rtl' : 'ltr'}>
                ...
                <div className="report-section">
                    <h2 className="report-section-title">
                        <div className="icon-chart-bar text-teal"></div>
                ...
                <div className="report-section">
                    <h2 className="report-section-title">
                        <div className="icon-line-chart text-teal"></div>
                ...
                {/* 5. Changes in Risk Concentration */}
                <div className="report-section">
                    <h2 className="report-section-title">
                        <div className="icon-map text-teal"></div>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="bg-carbon border border-ash rounded-[8px] overflow-hidden flex flex-col">
                            ...
                            <div className="h-[200px] relative bg-[#0a0d12] flex items-center justify-center">
                                <div className="absolute inset-0 opacity-20 bg-[url('https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Algeria_location_map.svg/500px-Algeria_location_map.svg.png')] bg-contain bg-no-repeat bg-center"></div>
                                {/* Mock Hotspot Marker */}
                                <div className="absolute w-4 h-4 bg-red rounded-full opacity-60" style={{top: '30%', left: '55%'}}></div>
                            </div>
                        ...
                        <div className="bg-carbon border border-ash rounded-[8px] overflow-hidden flex flex-col relative">
                            ...
                            <div className="bg-graphite px-4 py-2 border-b border-ash flex justify-between items-center">
                                ...
                                <span className="font-mono text-[11px] bg-red text-pure px-2 py-0.5 rounded shadow-[0_0_10px_rgba(218,54,51,0.5)]">3 Hotspots</span>
                            </div>
                            <div className="h-[200px] relative bg-[#0a0d12] flex items-center justify-center">
                                ...
                                <div className="absolute w-6 h-6 bg-red rounded-full opacity-80" style={{top: '30%', left: '55%'}}>
                                    <span className="animate-ping absolute inset-0 rounded-full bg-red opacity-50"></span>
                                </div>
                                <div className="absolute w-4 h-4 bg-red rounded-full opacity-80" style={{top: '33%', left: '52%'}}></div>
                                <div className="absolute w-4 h-4 bg-red rounded-full opacity-80" style={{top: '40%', left: '50%'}}></div>
                            </div>
                ...
                <div className="report-section">
                    <h2 className="report-section-title">
                        <div className="icon-file-plus text-teal"></div>
                ...
                {/* 6. Recommendations */}
                <div className="report-section mb-0">
                    <h2 className="report-section-title border-none mb-4">
                        <div className="icon-lightbulb text-amber"></div>
